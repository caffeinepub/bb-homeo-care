...
export class Backend implements backendInterface {
    ...
    async createPatientRecord(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createPatientRecord(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPatientRecord(arg0: string): Promise<PatientRecord> {
        if (this.processError) {
            try {
    ...
    async searchPatientRecords(arg0: string): Promise<Array<PatientRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchPatientRecords(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
